...
export default function TaskDetailPage() {
  ...
  const task: TaskDetail = {
    id: 1,
    title: "WALK DOG",
    description: "I need someone to walk my friendly golden retriever, Max, for 1 hour in the nearby park. Max is well-trained and loves to play fetch. Perfect for dog lovers!",
    category: "PETS",
    ...
    requirements: [
      "Must love dogs",
      "Experience with pets preferred",
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="p-4" style={{ backgroundColor: '#FFF8F0', border: '3px solid #6BCF7F' }}>
                    ...
                    <span style={{ fontSize: '14px', color: '#2D3748', fontWeight: 'bold' }}>{task.location}</span>
                  </div>
                </div>
              ...
              <div style={{ backgroundColor: 'white', border: '4px solid #2D3748', boxShadow: '6px 6px 0 rgba(0,0,0,0.15)', padding: '24px' }}>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div style={{ fontSize: '12px', color: '#2D3748', marginBottom: '4px' }}>{task.poster}</div>
                    <div className="flex items-center gap-1">
                      <span style={{ fontSize: '14px', color: '#FFD93D' }}>⭐</span>
                      <span style={{ fontSize: '10px', color: '#4A5568' }}>{task.posterRating}</span>
                    </div>
                  </div>
                </div>
                <button
